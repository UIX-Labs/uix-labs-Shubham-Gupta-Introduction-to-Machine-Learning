...
'''
data_ratings =pd.read_csv("data_files/ratings.csv") # empty df
data_movies = pd.read_csv( "data_files/movies.csv") # empty df
data_posters = pd.read_csv("data_files/movie_poster.csv") # empty df
